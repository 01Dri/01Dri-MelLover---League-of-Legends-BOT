...
class ApiRiot:
    ...
    def check_response(self, response):
        ...
        if response.status_code != 200:
            ...
            error_message_response = http_status_response['message']
            self.logger.get_logger_info_error().error(
                f'ERROR RIOT RESPONSE: {http_status_response} ERROR MESSAGE: {error_message_response}')
    ...
    def get_account_id_by_nick(self):
        ...
        self.puuid = response_api_json['puuid']
    ...
    def get_account_tier_rank_pdl_win_losses(self):
    ...
    def get_url_splash_art_best_champ_by_id_champ(self):
        ...
        self.nick_name_best_champ = re.sub(r'\s', '', self.nick_name_best_champ)
